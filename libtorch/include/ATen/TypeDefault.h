...
struct CAFFE2_API TypeDefault : public TypeExtendedInterface {
  ...
  Tensor & __and___out(Tensor & result, const Tensor & self, const Tensor & other) const override;
  ...
  Tensor & __or___out(Tensor & result, const Tensor & self, const Tensor & other) const override;
  ...
  Tensor & __xor___out(Tensor & result, const Tensor & self, const Tensor & other) const override;
  ...
  Tensor & __lshift___out(Tensor & result, const Tensor & self, const Tensor & other) const override;
  ...
  Tensor & __rshift___out(Tensor & result, const Tensor & self, const Tensor & other) const override;
  ...
  Tensor & _linspace_out(Tensor & result, Scalar start, Scalar end, int64_t steps) const override;
  Tensor _linspace(Scalar start, Scalar end, int64_t steps) const override;
  Tensor & _logspace_out(Tensor & result, Scalar start, Scalar end, int64_t steps) const override;
  Tensor _logspace(Scalar start, Scalar end, int64_t steps) const override;
  ...
  Tensor & th_addmm_out(Tensor & result, const Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta, Scalar alpha) const override;
  ...
  Tensor th_addmm(const Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta, Scalar alpha) const override;
  ...
  Tensor & _addmv_out(Tensor & result, const Tensor & self, const Tensor & mat, const Tensor & vec, Scalar beta, Scalar alpha) const override;
  ...
  Tensor _addmv(const Tensor & self, const Tensor & mat, const Tensor & vec, Scalar beta, Scalar alpha) const override;
  ...
  Tensor & _addr_out(Tensor & result, const Tensor & self, const Tensor & vec1, const Tensor & vec2, Scalar beta, Scalar alpha) const override;
  ...
  std::tuple<Tensor &,Tensor &> _gesv_single_out(Tensor & solution, Tensor & lu, const Tensor & self, const Tensor & A) const override;
  std::tuple<Tensor,Tensor> _gesv_single(const Tensor & self, const Tensor & A) const override;
  std::tuple<Tensor &,Tensor &> gels_out(Tensor & res1, Tensor & res2, const Tensor & self, const Tensor & A) const override;
  std::tuple<Tensor,Tensor> gels(const Tensor & self, const Tensor & A) const override;
  std::tuple<Tensor &,Tensor &> trtrs_out(Tensor & res1, Tensor & res2, const Tensor & self, const Tensor & A, bool upper, bool transpose, bool unitriangular) const override;
  ...
  std::tuple<Tensor &,Tensor &> symeig_out(Tensor & res1, Tensor & res2, const Tensor & self, bool eigenvectors, bool upper) const override;
  std::tuple<Tensor,Tensor> symeig(const Tensor & self, bool eigenvectors, bool upper) const override;
  std::tuple<Tensor &,Tensor &> eig_out(Tensor & res1, Tensor & res2, const Tensor & self, bool eigenvectors) const override;
  std::tuple<Tensor,Tensor> eig(const Tensor & self, bool eigenvectors) const override;
  std::tuple<Tensor &,Tensor &,Tensor &> svd_out(Tensor & res1, Tensor & res2, Tensor & res3, const Tensor & self, bool some) const override;
  std::tuple<Tensor,Tensor,Tensor> svd(const Tensor & self, bool some) const override;
  Tensor & _getri_out(Tensor & output, const Tensor & self) const override;
  Tensor _getri(const Tensor & self) const override;
  Tensor & potrf_out(Tensor & output, const Tensor & self, bool upper) const override;
  Tensor potrf(const Tensor & self, bool upper) const override;
  ...
  Tensor & potri_out(Tensor & output, const Tensor & self, bool upper) const override;
  Tensor potri(const Tensor & self, bool upper) const override;
  std::tuple<Tensor &,Tensor &> pstrf_out(Tensor & res1, Tensor & res2, const Tensor & self, bool upper, Scalar tol) const override;
  std::tuple<Tensor,Tensor> pstrf(const Tensor & self, bool upper, Scalar tol) const override;
  std::tuple<Tensor &,Tensor &> qr_out(Tensor & res1, Tensor & res2, const Tensor & self) const override;
  std::tuple<Tensor,Tensor> qr(const Tensor & self) const override;
  std::tuple<Tensor &,Tensor &> geqrf_out(Tensor & res1, Tensor & res2, const Tensor & self) const override;
  ...
  Tensor & threshold_out(Tensor & output, const Tensor & self, Scalar threshold, Scalar value) const override;
  ...
  Tensor & _sigmoid_out(Tensor & output, const Tensor & self) const override;
  Tensor _sigmoid(const Tensor & self) const override;
  ...
  Tensor & _tanh_out(Tensor & output, const Tensor & self) const override;
  Tensor _tanh(const Tensor & self) const override;
  ...
  Tensor & thnn_batch_norm_out(Tensor & output, const Tensor & self, const Tensor & weight, const Tensor & bias, const Tensor & running_mean, const Tensor & running_var, bool training, double momentum, double eps) const override;
  Tensor thnn_batch_norm(const Tensor & self, const Tensor & weight, const Tensor & bias, const Tensor & running_mean, const Tensor & running_var, bool training, double momentum, double eps) const override;
  ...
  Tensor clamp(const Tensor & self, Scalar min, Scalar max) const override;
  ...
  Tensor index_put(const Tensor & self, TensorList indices, const Tensor & values) const override;
  Tensor & index_put_(Tensor & self, TensorList indices, const Tensor & values) const override;
  ...
  bool is_cuda(const Tensor & self) const override;
  ...
  bool is_sparse(const Tensor & self) const override;
  ...
  Tensor & linspace_out(Tensor & result, Scalar start, Scalar end) const override;
  ...
  Tensor mean(const Tensor & self, int64_t dim, bool keepdim, ScalarType dtype) const override;
  Tensor mean(const Tensor & self, int64_t dim, bool keepdim) const override;
  Tensor mean(const Tensor & self, int64_t dim, ScalarType dtype) const override;
  Tensor & mean_out(Tensor & result, const Tensor & self, int64_t dim, bool keepdim, ScalarType dtype) const override;
  Tensor & mean_out(Tensor & result, const Tensor & self, int64_t dim, bool keepdim) const override;
  Tensor & mean_out(Tensor & result, const Tensor & self, int64_t dim, ScalarType dtype) const override;
  ...
  Tensor _sum(const Tensor & self, IntList dim, bool keepdim) const override;
  ...
  Tensor & _sum_out(Tensor & result, const Tensor & self, IntList dim, bool keepdim) const override;
  ...
  Tensor std(const Tensor & self, int64_t dim, bool unbiased, bool keepdim) const override;
  Tensor & std_out(Tensor & result, const Tensor & self, int64_t dim, bool unbiased, bool keepdim) const override;
  ...
  Tensor _prod(const Tensor & self, int64_t dim, bool keepdim) const override;
  ...
  Tensor sparse_coo_tensor(const Tensor & indices, const Tensor & values) const override;
  Tensor sparse_coo_tensor(const Tensor & indices, const Tensor & values, IntList size) const override;
  Tensor _native_sparse_coo_tensor_unsafe(const Tensor & indices, const Tensor & values, IntList size) const override;
  Tensor _sparse_coo_tensor_unsafe(const Tensor & indices, const Tensor & values, IntList size) const override;
  ...
  int64_t get_device(const Tensor & self) const override;
  Tensor to(const Tensor & self, Device device, ScalarType dtype, bool non_blocking) const override;
  Tensor to(const Tensor & self, ScalarType dtype, bool non_blocking) const override;
  Tensor to(const Tensor & self, Device device, bool non_blocking) const override;
  Tensor to(const Tensor & self, const Tensor & other, bool non_blocking) const override;
  std::vector<Tensor> meshgrid(TensorList tensors) const override;
  Scalar _local_scalar(const Tensor & self) const override;
