...
inline Tensor dispatch__copy_ignoring_overlaps_(Tensor self, const Tensor & src) {
  ...
  AutoNoGIL no_gil;
  return at::_copy_ignoring_overlaps_(self, src);
}
...
inline Tensor dispatch__cudnn_init_dropout_state(double dropout, bool train, int64_t dropout_seed, const Type & self_ty, at::optional<int32_t> device) {
...
inline int64_t dispatch__dimI(const Tensor & self) {

  AutoNoGIL no_gil;
  return at::_dimI(self);
}
inline int64_t dispatch__dimV(const Tensor & self) {

  AutoNoGIL no_gil;
  return at::_dimV(self);
}
...
inline Tensor dispatch__erfc(const Tensor & self, Tensor result) {

  AutoNoGIL no_gil;
  return at::_erfc_out(result, self);
}
inline Tensor dispatch__erfc(const Tensor & self) {

  AutoNoGIL no_gil;
  return at::_erfc(self);
}
...
inline std::tuple<Tensor,Tensor> dispatch__thnn_fused_gru_cell(const Tensor & input_gates, const Tensor & hidden_gates, const Tensor & hx, const Tensor & input_bias, const Tensor & hidden_bias) {

  AutoNoGIL no_gil;
  return at::_thnn_fused_gru_cell(input_gates, hidden_gates, hx, input_bias, hidden_bias);
}
inline std::tuple<Tensor,Tensor,Tensor> dispatch__thnn_fused_lstm_cell(const Tensor & input_gates, const Tensor & hidden_gates, const Tensor & cx, const Tensor & input_bias, const Tensor & hidden_bias) {

  AutoNoGIL no_gil;
  return at::_thnn_fused_lstm_cell(input_gates, hidden_gates, cx, input_bias, hidden_bias);
}
...
inline Tensor dispatch_clamp_(Tensor self, Scalar min, Scalar max) {
...
inline int64_t dispatch_get_device(const Tensor & self) {
...
inline Tensor dispatch_index_put(const Tensor & self, TensorList indices, const Tensor & values) {

  AutoNoGIL no_gil;
  return self.index_put(indices, values);
}
...
inline Tensor dispatch_linspace(Scalar start, Scalar end, Tensor result) {

  AutoNoGIL no_gil;
  return at::linspace_out(result, start, end);
}
inline Tensor dispatch_linspace(Scalar start, Scalar end, const TensorOptions & options) {
  maybe_initialize_cuda(options);
  AutoNoGIL no_gil;
  return torch::linspace(start, end, options);
}
...
inline Tensor dispatch_log_softmax_backward_data(const Tensor & grad_output, const Tensor & output, int64_t dim, const Tensor & self) {
  ...
  AutoNoGIL no_gil;
  return at::log_softmax_backward_data(grad_output, output, dim, self);
}
...
inline Tensor dispatch_mean(const Tensor & self, int64_t dim, ScalarType dtype, Tensor result) {

  AutoNoGIL no_gil;
  return at::mean_out(result, self, dim, dtype);
}
inline Tensor dispatch_mean(const Tensor & self, int64_t dim, ScalarType dtype) {

  AutoNoGIL no_gil;
  return self.mean(dim, dtype);
}
inline Tensor dispatch_mean(const Tensor & self, int64_t dim, bool keepdim, ScalarType dtype, Tensor result) {

  AutoNoGIL no_gil;
  return at::mean_out(result, self, dim, keepdim, dtype);
}
inline Tensor dispatch_mean(const Tensor & self, int64_t dim, bool keepdim, ScalarType dtype) {
...
inline int64_t dispatch_native_get_device(const Tensor & self) {

  AutoNoGIL no_gil;
  return at::native_get_device(self);
}
...
inline Tensor dispatch_softmax_backward_data(const Tensor & grad_output, const Tensor & output, int64_t dim, const Tensor & self) {
  ...
  AutoNoGIL no_gil;
  return at::softmax_backward_data(grad_output, output, dim, self);
}
...
inline Tensor dispatch_th_addmm(const Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta, Scalar alpha, Tensor result) {

  AutoNoGIL no_gil;
  return at::th_addmm_out(result, self, mat1, mat2, beta, alpha);
}
inline Tensor dispatch_th_addmm(const Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta, Scalar alpha) {

  AutoNoGIL no_gil;
  return at::th_addmm(self, mat1, mat2, beta, alpha);
}
inline Tensor dispatch_th_addmm_(Tensor self, const Tensor & mat1, const Tensor & mat2, Scalar beta, Scalar alpha) {

  AutoNoGIL no_gil;
  return at::th_addmm_(self, mat1, mat2, beta, alpha);
}
inline Tensor dispatch_th_clone(const Tensor & self) {

  AutoNoGIL no_gil;
  return at::th_clone(self);
}
inline Tensor dispatch_th_norm(const Tensor & self, Scalar p) {

  AutoNoGIL no_gil;
  return at::th_norm(self, p);
}
inline Tensor dispatch_th_pow(const Tensor & self, Scalar exponent, Tensor result) {

  AutoNoGIL no_gil;
  return at::th_pow_out(result, self, exponent);
}
inline Tensor dispatch_th_pow(const Tensor & self, Scalar exponent) {

  AutoNoGIL no_gil;
  return at::th_pow(self, exponent);
}
inline Tensor dispatch_th_resize_as_(Tensor self, const Tensor & the_template) {

  AutoNoGIL no_gil;
  return at::th_resize_as_(self, the_template);
}
inline Tensor dispatch_th_zero_(Tensor self) {

  AutoNoGIL no_gil;
  return at::th_zero_(self);
}
