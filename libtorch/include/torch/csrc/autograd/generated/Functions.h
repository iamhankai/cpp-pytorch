...
struct ThAddmmBackward : public TraceableFunction {
  using TraceableFunction::TraceableFunction;
  variable_list apply(variable_list&& grads) override;
  std::string name() const override { return "ThAddmmBackward"; }
  void release_variables() override {
    mat1_.reset_data();
...
struct SNativeAddmmBackward : public TraceableFunction {
  using TraceableFunction::TraceableFunction;
  variable_list apply(variable_list&& grads) override;
  std::string name() const override { return "SNativeAddmmBackward"; }
  void release_variables() override {
    mat1_.reset_data();
    mat1_.reset_grad_function();
    mat2_.reset_data();
...
struct GesvSingleBackward : public TraceableFunction {
  using TraceableFunction::TraceableFunction;
  variable_list apply(variable_list&& grads) override;
  std::string name() const override { return "GesvSingleBackward"; }
  void release_variables() override {
    self_.reset_data();
    self_.reset_grad_function();
    A_.reset_data();
...
struct GesvHelperBackward : public TraceableFunction {
  using TraceableFunction::TraceableFunction;
  variable_list apply(variable_list&& grads) override;
  std::string name() const override { return "GesvHelperBackward"; }
  void release_variables() override {
    self_.reset_data();
    self_.reset_grad_function();
    A_.reset_data();
...
struct PotrfBackward : public TraceableFunction {
  using TraceableFunction::TraceableFunction;
  variable_list apply(variable_list&& grads) override;
  std::string name() const override { return "PotrfBackward"; }
  void release_variables() override {
    output_.reset_data();
...
struct SvdBackward : public TraceableFunction {
  ...
  void release_variables() override {
    ...
    self_.reset_grad_function();
    res1_.reset_data();
    res1_.reset_grad_function();
    res2_.reset_data();
    res2_.reset_grad_function();
    res3_.reset_data();
    res3_.reset_grad_function();
  }
...
struct ReluBackward : public TraceableFunction {
  using TraceableFunction::TraceableFunction;
  variable_list apply(variable_list&& grads) override;
...
struct ThnnBatchNormBackward : public TraceableFunction {
  using TraceableFunction::TraceableFunction;
  variable_list apply(variable_list&& grads) override;
  std::string name() const override { return "ThnnBatchNormBackward"; }
  void release_variables() override {
    self_.reset_data();
    self_.reset_grad_function();
    weight_.reset_data();
...
struct ThnnBatchNormBackwardBackward : public TraceableFunction {
  using TraceableFunction::TraceableFunction;
  variable_list apply(variable_list&& grads) override;
  std::string name() const override { return "ThnnBatchNormBackwardBackward"; }
  void release_variables() override {
    save_mean_.reset_data();
    save_mean_.reset_grad_function();
    save_std_.reset_data();
